...
public class Cd implements Document{
	...
	public Cd(int id, String nom, String auteur) {
		this.id=id;
		this.nom=nom;
		this.auteur=auteur;
	}
	...
	public Object[] affiche() {
		if(possesseur != null) {
			String[] tab = {id.toString(),"cd",nom,auteur,possesseur.toString()};
			return tab;
		}
		else {
			String[] tab = {id.toString(),"cd",nom,auteur,"Aucun possesseur"};
			return tab;
		}
	}
